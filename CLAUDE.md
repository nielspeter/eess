...
| [014](./adr/014-the-emitter-refuses-a-verdict-without-evidence.md) | Evidence at Emission | ADR-010's evidence requirement extends from the terminal to the emitters: `finishPreset`/`reportViolations` take `{ violations, examined }`, and an evidence-free verdict is a configuration finding. A required field, not a registry — the target is the honest mistake. (Accepted 2026-09-03) |
