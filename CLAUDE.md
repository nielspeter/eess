...
| [011](./adr/011-the-kernels-public-api-is-explicit.md)    | Kernel API      | The kernel root is public API; family plumbing moves behind `@nielspeter/eess/internal`. (Proposed; classification `pending`) |
