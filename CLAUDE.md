...
| [011](./adr/011-a-dialect-publishes-its-modelled-vocabulary.md) | Kind Vocabulary | A dialect owns and publishes the artifact kinds it models; bindings declare consumption against it, never restate it. Three categories — modelled · known-unmodelled · unknown — and only a sibling's is deniable. (Prospective; plan 0214.) |
