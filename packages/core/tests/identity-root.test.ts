...
import { discoverIdentityRoot, normalizeIdentityText } from '../src/identity-root.js'
...
function scratch(): string {
  const dir = fs.mkdtempSync(path.join(os.tmpdir(), 'eess-root-'))
  created.push(dir)
  return dir
}
