 ...
 * [ts-archunit plan 0088](https://github.com/nielspeter/ts-archunit/blob/main/plans/0088-a-slice-finding-identifies-itself.md).
 *
 ...
 *     [ts-archunit bug 0056](https://github.com/nielspeter/ts-archunit/blob/main/bugs/fixed/0056-a-cycle-identity-changes-when-imports-are-reordered.md).
 *
 * This is [ts-archunit bug 0028](https://github.com/nielspeter/ts-archunit/blob/main/bugs/fixed/0028-two-findings-in-one-file-can-share-a-baseline-identity.md)'s
 * shape in the family that never got the fix. ts-archunit's `docs/upgrading.md`'s own 0.28.0 row says it
