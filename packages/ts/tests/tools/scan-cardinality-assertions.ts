 ...
 *
 * [ADR-009](../../../../adr/009-agent-first-failure-surfaces.md) rule 5's third
 ...
 *
 * [ts-archunit Plan 0079](https://github.com/nielspeter/ts-archunit/blob/main/plans/completed/0079-triage-the-cardinality-only-assertions.md)
...
export function scanCardinalityAssertions(repo: string): {
  ...
  for (const file of testFiles(path.join(repo, 'tests'))) {
    ...
    // [ts-archunit bug 0036](https://github.com/nielspeter/ts-archunit/blob/main/bugs/fixed/0036-the-relative-glob-audit-is-incomplete.md),
