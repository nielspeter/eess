 ...
 *
 * That is the machine-dependent shape [ts-archunit bug 0011](https://github.com/nielspeter/ts-archunit/blob/main/bugs/fixed/0011-dogfood-rules-select-nothing.md)
