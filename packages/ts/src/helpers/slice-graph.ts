 ...
 * slice conditions until [ts-archunit bug 0059](https://github.com/nielspeter/ts-archunit/blob/main/bugs/fixed/0059-slice-conditions-and-module-conditions-disagree-about-a-dependency.md),
 ...
 * [ts-archunit bug 0022](https://github.com/nielspeter/ts-archunit/blob/main/bugs/fixed/0022-forward-import-conditions-are-blind-to-reexports-and-dynamic-imports.md)
 ...
 * construct that BREAKS cycles and telling them to remove it. ADR-009 rule 2, from a
...
export interface SliceDependencySite {
   ...
   *
   * Added by [ts-archunit plan 0088](https://github.com/nielspeter/ts-archunit/blob/main/plans/0088-a-slice-finding-identifies-itself.md): the
