...
type StrictBoundariesRuleId = (typeof RULE_IDS)[number]
    ...
    builders.push(
      ...collectRule(
          ...
          .onlyImportFromWithOptions(allowedGlobs, options.importOptions ?? {}),
        {
          ...
          // ([ts-archunit bug 0017](https://github.com/nielspeter/ts-archunit/blob/main/bugs/fixed/0017-boundaries-no-cross-boundary-message-overclaims-entry-point-enforcement.md)).
