...
| [0155](./fixed/0155-a-rule-with-no-condition-passes-in-total-silence.md)                    | a rule that selects subjects and chains no condition passes silently — the guard is unreachable for every rule written with `.should()`                                                     | High     | 🔴 Draft            | self-found · fold audit vs ts-archunit bug 0019                              | —         |
