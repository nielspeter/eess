...
| [0086](./fixed/0086-links-to-directories-do-not-resolve.md)               | a link to a directory that exists is reported broken — the blocker for gating `work/bugs/`                                                                          | Medium   | ✅ Fixed → `fixed/` | self-found · extending `check:corpus` to `work/bugs/**`                      | TBD       |
