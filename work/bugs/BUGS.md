...
| [0127](./fixed/0127-nonvacuity-proves-a-condition-not-a-wired-rule.md)    | no `gateNode` fixture proves the production gate still invokes its rule — two rebuild it, five exercise the preset; 36 of 45 dogfood rules have none                | High     | ✅ Fixed → `fixed/` | self-found · instrumented both kernel seams while scoping 0088               | #57       |
