...
| [0170](./0170-linesofcode-counts-comments-so-documentation-reads-as-size.md)                      | `linesOfCode` counts comments, so a documented class fails `maxClassLines` on its own JSDoc — which a sibling rule requires                                                                 | Draft                       |
| [0171](./0171-a-metric-unit-change-silently-loosens-every-baselined-ratchet.md)                   | a metric unit change silently loosens every baselined ratchet — a class could triple with the build green                                                                                   | Draft                       |
...
| [0173](./0173-the-line-index-cache-serves-a-stale-measurement.md)                                 | the line-index cache served a stale measurement — a public metric returned a number matching nothing after any edit                                                                         | Draft                       |
