...
| [006 — mermaid beyond `classDiagram`, and diagrams in Markdown](./006-mermaid-beyond-classdiagram.md) | Medium   | ⚪ Filed    | —              | inbound · consuming project | survey found Ask A already ships via `packages/crossvalidate/src/md-mermaid.ts:143`; Ask B needs a break class per diagram type                                                                                                                                                                                                                                                                                  |
