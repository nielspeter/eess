...
| [0165 — integrate the copied ts-archunit engine](./0165-integrate-the-copied-ts-archunit-engine.md) | High     | Draft | the 38 engine failures → 0, the kernel re-split, and eess's own additions (`report`, `--fix`, `havePathMatching`) restored — plan 0088's real remaining scope, with a runnable success criterion                                          | — buildable now, off baseline `9489684`                                                                                                                           |
