...
| [0165 — integrate the copied ts-archunit engine](./0165-integrate-the-copied-ts-archunit-engine.md) | High     | Draft | Phase 1 done — engine failures 0 (29 measured, not 38); Phase 2 (kernel re-split, `.select()`) and Phase 3 (`report`, `--fix`, `havePathMatching`) open                                                                                   | — buildable now, off baseline `9489684`                                                                                                                           |
