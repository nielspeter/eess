...
| 8     | [Working-method kit (0068)](./0068-working-method-kit.md)                           | portable method: current docs + seed templates + skills (`/plan-*`, `/bug`, universal `/close`) + one promoted gate (close); freeze stays a skill-borne habit | Draft   | 0058 (0067 informs) |
...
[Plan 0068](./0068-working-method-kit.md) packages the _guidelines_ half of the
