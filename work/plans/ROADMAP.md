...
| [0146 — gherkin-ts example, full coverage](./0146-gherkin-ts-example-full-coverage.md)       | Medium   | Draft | 0091 follow-up: `examples/cross-dialect.gherkin-ts.test.ts` demonstrates `scenariosCovered` + `scenarioExemptionsCurrent`, not just `scenarioTestsResolve` — closes the gap 0091's own review disclosed rather than built                 | — buildable now                                                                        |
