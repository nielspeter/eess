...
All public exports from `eess-ts`, organized by category.
...
| Export                   | Signature                                                                              | Description                                              |
| ------------------------ | -------------------------------------------------------------------------------------- | -------------------------------------------------------- |
| `parseExclusionComments` | `parseExclusionComments(source: string, file: string): ParseResult`                    | Parse `// eess-exclude` comments from source text.       |
...
## GraphQL Extension (`eess-ts/graphql`)
