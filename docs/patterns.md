...
```typescript
import { definePattern } from '@nielspeter/eess-ts'
...
```typescript
import { definePattern, arrayOf, isString } from '@nielspeter/eess-ts'
...
```typescript
import { project, functions, definePattern } from '@nielspeter/eess-ts'
...
```typescript
import { definePattern, arrayOf, matching } from '@nielspeter/eess-ts'
