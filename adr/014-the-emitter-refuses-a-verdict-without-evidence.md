...
| No new kernel registry is added                                                | 1    | `packages/core/src/cardinality.ts` remains the sole home of the kernel-bound `WeakSet` registries ADR-010 §2 caps; a rule in `arch.internal.rules.ts` asserting no other module under `packages/core/src` constructs one — owned by [plan 0263](../work/plans/0263-adr-014s-residual-enforcement-rows.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | `pending` |
