...
| ---------------------------------------------------------- | ---- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| Confinement: only the engine module imports ts-morph       | 1    | eess-ts import ban in `arch.rules.ts` — the code does not satisfy this yet (ts-morph imported across eess-ts); the honest declared gap this ADR exists to close | pending |
