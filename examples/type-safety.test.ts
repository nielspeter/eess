 ...
 *
 * Uses the standard rules from eess-ts/rules/typescript and
 * eess-ts/rules/security — no custom conditions needed.
 */
import { describe, it } from 'vitest'
import { project, classes, functions, types, not, isString, access } from '@nielspeter/eess-ts'
import {
  noAnyProperties,
  noTypeAssertions,
  noNonNullAssertions,
